...
import com.example.sistemas.appinventariolocaldb.Entities.CargaMasInventario;
...
import static com.example.sistemas.appinventariolocaldb.Utilidades.Utilidad.CAMPO_COD_BODEGA_INVENTARIO_CABECERA;
import static com.example.sistemas.appinventariolocaldb.Utilidades.Utilidad.CAMPO_CONTEO_INVENTARIO_CABECERA;
...
import static com.example.sistemas.appinventariolocaldb.Utilidades.Utilidad.CAMPO_ESTADO_INVENTARIO_CABECERA;
import static com.example.sistemas.appinventariolocaldb.Utilidades.Utilidad.CAMPO_FECHA_INVENTARIO_CABECERA;
...
import static com.example.sistemas.appinventariolocaldb.Utilidades.Utilidad.TABLA_USUARIO;
...
*/
    ...
    private void verificarUsuarioLocalDB(String etusuario, String clave) {
            ...
            try {
                ...
                Cursor cursor=db.rawQuery("SELECT * " + " FROM " + TABLA_USUARIO+" WHERE "+Utilidad.CAMPO_COD_USUARIO+"=? AND " +Utilidad.CAMPO_CLAVE+"=?",parametros);
                cursor.moveToFirst();
                            ...
                            try {
                                ...
                                if (success){
                                    ...
                                    if (error) {
                                        ...
                                        CargarInventario(usuario.getCodAlmacen(),"admin");
                                    }
                                }else{
